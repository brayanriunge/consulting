...
export default function AboutUs() {
  return (
    <section
      ...
      id="about"
    >
      <div className="flex flex-col md:flex-row lg:flex-row justify-items-center container sm:px-6 lg:px-8  mx-auto py-10 px-8 gap-4 w-full">
      ...
      <div className=" container mx-auto px-4 sm:px-6 lg:px-8  h-full ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto justify-center">
          <div className="bg-secondary flex flex-col items-center  rounded-md rounded-br-[100px] ">
            <div className="m-8">
